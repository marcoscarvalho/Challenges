package br.com.hackerrank.challenges.day14;
...
import br.com.hackerrank.challenges.daysofcode.day14.Scope;

public class TestScope extends InitialTest {

	private final String path = "tests/Challenge/30DaysOfCode/Scope/";

	@Test
	public void testChallengeTest01() throws Exception {

		File fileIn = new File(path + "input01.txt");
		new Scope(new FileInputStream(fileIn)).execute();
