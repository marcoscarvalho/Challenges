package br.com.hackerrank.challenges.day28;
...
import br.com.hackerrank.challenges.daysofcode.day28.RegExPatterns;

public class TestRegExPatterns extends InitialTest {

	private final String path = "tests/Challenge/30DaysOfCode/RegExPatterns/";

	@Test
	public void testChallengeTest01() throws Exception {

		File fileIn = new File(path + "input01.txt");
		new RegExPatterns(new FileInputStream(fileIn)).execute();
