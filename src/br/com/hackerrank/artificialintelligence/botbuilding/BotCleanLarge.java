...
public class BotCleanLarge {
	...
	public BotCleanLarge() {
		this(System.in);
	}

	public BotCleanLarge(InputStream in) {
		systemIn = in;
	}

	public BotCleanLarge(InputStream in, int qtdIt, boolean debugg) {
		systemIn = in;
		qtdIteracoes = qtdIt;
		debug = debugg;
	}
	...
	private List<DirtyCell> getCenarios(int xBot, int yBot, String[] board) {
		List<DirtyCell> dirtyCells = new ArrayList<BotCleanLarge.DirtyCell>();
